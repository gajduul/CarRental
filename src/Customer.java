public class Customer {
    ...
    public boolean hasRentedCars(Car car){return rentedCar == car;} //Metoda pomocnicza zwracająca wartość true/false. Porównuje czy auto wypożyczone przez użytkownika to to samo auto co to do oddania
